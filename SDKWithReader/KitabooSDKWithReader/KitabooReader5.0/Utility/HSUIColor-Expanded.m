...
@implementation UIColor (ePUBUIColor_Expanded)
...
+ (UIColor *)colorFromArray:(NSArray*)colorInfo{
    //CGFloat r,g,b,a;
	if ([colorInfo count]!=4) return [self blackColor];
    
    return [[UIColor alloc] initWithRed:[colorInfo[0] floatValue] green:[colorInfo[1] floatValue] blue:[colorInfo[2] floatValue] alpha:[colorInfo[3] floatValue]];
...
+ (UIColor *) ios7Gray {
    return [self colorWithRed:151/255.0 green:152/255.0 blue:153/255.0 alpha:1.0];
}
...
+ (UIColor *)colorWithHexString:(NSString *)stringToConvert {
	if([stringToConvert length] > 6){
		stringToConvert = [stringToConvert substringFromIndex:[stringToConvert length] - 6];
	}
	NSScanner *scanner = [NSScanner scannerWithString:stringToConvert];
	unsigned hexNum;
