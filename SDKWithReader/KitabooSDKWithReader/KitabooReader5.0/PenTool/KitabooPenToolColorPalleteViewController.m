...
@interface KitabooPenToolColorPalleteViewController ()
{
...
@implementation KitabooPenToolColorPalleteViewController
...
- (void)viewDidLoad
{
    ...
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:penItemsBar attribute:NSLayoutAttributeLeading relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeLeading multiplier:1.0 constant:isIPAD?0:4]];
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:penItemsBar attribute:NSLayoutAttributeTrailing relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeTrailing multiplier:1.0 constant:isIPAD?0:-4]];
    ...
    [secondLinePenItemBar.leadingAnchor constraintEqualToAnchor:penItemsBar.leadingAnchor constant:0].active = YES;
    [secondLinePenItemBar.trailingAnchor constraintEqualToAnchor:penItemsBar.trailingAnchor constant:0].active = YES;
