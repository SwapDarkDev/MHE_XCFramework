...
@interface KitabooPenToolThicknessPalleteViewController ()
{
...
@implementation KitabooPenToolThicknessPalleteViewController
...
//    [slider.heightAnchor constraintEqualToConstant:20].active = YES;
    [slider.leadingAnchor constraintEqualToAnchor:pointItemsBar.leadingAnchor constant:20].active = YES;
    [slider.trailingAnchor constraintEqualToAnchor:pointItemsBar.trailingAnchor constant:-20].active = YES;
    ...
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:pointItemsBar attribute:NSLayoutAttributeLeading relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeLeading multiplier:1.0 constant:0]];
    [self.view addConstraint:[NSLayoutConstraint constraintWithItem:pointItemsBar attribute:NSLayoutAttributeTrailing relatedBy:NSLayoutRelationEqual toItem:self.view attribute:NSLayoutAttributeTrailing multiplier:1.0 constant:0]];
//    if(!isIPAD)
    [self addShadow];
...
-(UIView *)getItemForSlider
{
    ...
    [slider.leadingAnchor constraintEqualToAnchor:actionBarItem.leadingAnchor constant:0].active = YES;
    [slider.trailingAnchor constraintEqualToAnchor:actionBarItem.trailingAnchor constant:0].active = YES;
