...
-(NSDictionary*)getAllUGCDictionaryForUserID:(NSNumber*)userID withBookID:(NSNumber *)bookId andPageID:(NSNumber *)pageID;
-(void)deleteAllUGCForBookID:(NSNumber *)bookID UserID:(NSNumber *)userID andPageID:(NSNumber *)pageID;
